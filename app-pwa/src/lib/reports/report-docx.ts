...
/**
 * Editable Word (.docx) version of the one-page field report. Built from
 * buildReportContent as real OpenXML the user can edit and re-save in Word /
 * Google Docs. Runs server-side in the API route via Packer.toBuffer.
 */
...
/** Build the report document model (shared by Blob/Buffer packers). */
