 ...
 * WAV (not MediaRecorder's webm/opus) because faster-whisper decodes wav/mp3/
 * m4a/ogg/flac/aac cleanly and webm produced garbled/empty transcripts. WAV
 * also makes server-side duration + the 60s clamp work.
 */
